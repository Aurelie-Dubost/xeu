...
# Find the most decorrelated time series
most_decorrelated_ts = average_r_squared.idxmin()
print(f"The most decorrelated time series relative to 'Ref_TS' is {most_decorrelated_ts} with an average R-squared of {average_r_squared[most_decorrelated_ts]}")
